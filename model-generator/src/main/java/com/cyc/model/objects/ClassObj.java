...
public class ClassObj extends ModelObj {
  ...
  public ClassObj(InterfaceObj io, ContextMap contextMap) throws ModelGeneratorException {
    ...
    */ 
    ...
    imports.add(ModelRuntimeException.class.getCanonicalName());
    imports.add(KbException.class.getCanonicalName());
    ...
    if ((this.getPrimaryImpl().getExtendsInterface() == null) 
            || this.getPrimaryImpl().getExtendsInterface().equals("Empty")){
    ...
    if (getPrimaryImpl().getRelationType() == null) {
       throw new ModelGeneratorException("Relation type cannot be null.");
    } else if (getPrimaryImpl().getRelationType().equals("isa")) {
