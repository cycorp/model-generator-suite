...
import com.cyc.model.AbstractCycModelObjectProvider;
...
public class ClassObjProviderTemplate extends ClassTemplate {
  ...
  public void populateFromObj(ClassObj obj) {
    ...
    addImports(Arrays.asList(implName,
            AbstractCycModelObjectProvider.class.getCanonicalName(),
            ModelException.class.getCanonicalName(),
            ModelRuntimeException.class.getCanonicalName(),
            "java.io.IOException",
            "java.util.ArrayList",
